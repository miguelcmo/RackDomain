...
class PlatformController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Platform']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->platformId));
		}
	...
	public function getVendorOptions()
	{
		...
		$criteria->order = 'vendorName ASC';
		$vendorOptions = Vendor::model()->findAll($criteria);
		return CHtml::listData($vendorOptions, 'vendorId', 'vendorName');
	}
	
	public function getChapterOptions()
	{
		$chapterOptions = Chapter::model()->findAll();
		return CHtml::listData($chapterOptions, 'chapterId', 'chapterName');
	}
}

...
-- ----------------------------
INSERT INTO `assignments` VALUES ('Authority', '0', '', 's:0:\"\";');
INSERT INTO `assignments` VALUES ('Coordinator', '1', '', 's:0:\"\";');
INSERT INTO `assignments` VALUES ('Technician', '2', '', 's:0:\"\";');
INSERT INTO `assignments` VALUES ('Technician', '3', '', 's:0:\"\";');
INSERT INTO `assignments` VALUES ('Technician', '4', '', 's:0:\"\";');
...
-- ----------------------------
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsAdmin');
INSERT INTO `itemchildren` VALUES ('Coordinator', 'SdsAdministrating');
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsCreate');
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsDelete');
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsIndex');
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsUpdate');
INSERT INTO `itemchildren` VALUES ('SdsAdministrating', 'SdsView');
INSERT INTO `itemchildren` VALUES ('SdsViewing', 'SdsView');
INSERT INTO `itemchildren` VALUES ('Coordinator', 'SdsViewing');
INSERT INTO `itemchildren` VALUES ('Technician', 'SdsViewing');
...
INSERT INTO `items` VALUES ('Authority', '2', null, null, null);
INSERT INTO `items` VALUES ('Coordinator', '2', 'Infrastructure coordinator, manage the SDS and all functions associated to them.', '', 's:0:\"\";');
INSERT INTO `items` VALUES ('SdsAdmin', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsAdministrating', '1', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsCreate', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsDelete', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsIndex', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsUpdate', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsView', '0', null, null, 'N;');
INSERT INTO `items` VALUES ('SdsViewing', '1', null, null, 'N;');
INSERT INTO `items` VALUES ('Technician', '2', 'Responsible for update the information related with the SDS and all the associated functions.', '', 's:0:\"\";');
...
-- Records of tbl_rack
-- ----------------------------
INSERT INTO `tbl_rack` VALUES ('1', '1', '13', 'Rack 1', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('2', '1', '12', 'Rack 2', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('3', '1', '11', 'Rack 3', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('4', '1', '10', 'Rack 4', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('5', '1', '9', 'Rack 5', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('6', '1', '8', 'Rack 6', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('7', '1', '7', 'Rack 7', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('8', '1', '6', 'Rack 8', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('9', '1', '5', 'Rack 9', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('10', '1', '4', 'Rack 10', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('11', '1', '3', 'Rack 11', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('12', '1', '2', 'Rack 12', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('13', '1', '1', 'Rack 13', 'F', '1', null, null, null, null, '1', '1');
INSERT INTO `tbl_rack` VALUES ('14', '1', '0', 'Rack 13', 'F', '1', '2015-05-21 20:03:10', '0', '2015-05-21 20:03:10', '0', '1', '1');
INSERT INTO `tbl_rack` VALUES ('15', '2', '1', '1', 'F', '1', '2015-05-21 20:36:25', '0', '2015-05-21 20:36:25', '0', '1', '1');
INSERT INTO `tbl_rack` VALUES ('16', '2', '4', '2', 'F', '1', '2015-05-21 20:36:44', '0', '2015-05-21 20:36:44', '0', '1', '1');
INSERT INTO `tbl_rack` VALUES ('17', '3', '0', 'Rack 1', 'F', '1', '2015-05-21 20:39:54', '0', '2015-05-21 20:39:54', '0', '1', '1');
INSERT INTO `tbl_rack` VALUES ('18', '3', '1', 'Rack 2', 'F', '1', '2015-05-22 20:04:15', '1', '2015-05-22 20:04:15', '1', '1', '1');
INSERT INTO `tbl_rack` VALUES ('19', '3', '3', 'Rack 3', 'F', '1', '2015-05-22 20:04:19', '1', '2015-05-22 20:04:19', '1', '1', '1');
INSERT INTO `tbl_rack` VALUES ('20', '3', '4', 'Rack 4', 'F', '1', '2015-05-22 20:04:23', '1', '2015-05-22 20:04:23', '1', '1', '1');
INSERT INTO `tbl_rack` VALUES ('21', '3', '2', 'Rack 5', 'F', '1', '2015-05-22 20:04:28', '1', '2015-05-22 20:04:28', '1', '1', '1');
INSERT INTO `tbl_rack` VALUES ('22', '3', '5', 'Rack 3R', 'F', '1', '2015-05-22 20:08:20', '1', '2015-05-22 20:08:20', '1', '1', '1');
...
CREATE TABLE `tbl_room` (
  ...
  `Flag` int(11) DEFAULT '1',
  PRIMARY KEY (`roomId`),
  KEY `fk_room_sds` (`sdsId`),
  CONSTRAINT `fk_room_sds` FOREIGN KEY (`sdsId`) REFERENCES `tbl_sds` (`sdsId`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tbl_room
-- ----------------------------
INSERT INTO `tbl_room` VALUES ('1', '112', 'Room 1', 'Shelter tunja', 'Shelter principal equipos hfc red bidireccional Tunja', '1', '2015-05-21 09:01:26', '1', '2015-05-21 09:01:26', '1', '1', '1');
INSERT INTO `tbl_room` VALUES ('2', '114', 'Outdoor room', 'Grupo de racks outdoor', 'Fila de racks outdoor en el patio principal', '1', '2015-05-21 20:31:01', '0', '2015-05-21 20:31:01', '0', '1', '1');
INSERT INTO `tbl_room` VALUES ('3', '113', 'Cuarto Principal', 'Cuarto de equipos principal', '', '1', '2015-05-21 20:38:52', '0', '2015-05-21 20:38:52', '0', '1', '1');
...
-- Records of tbl_row
-- ----------------------------
INSERT INTO `tbl_row` VALUES ('1', '1', 'Row 1', 'Fila forward', '2015-05-21 09:03:26', '1', '2015-05-21 09:03:26', '1', '1', '1');
INSERT INTO `tbl_row` VALUES ('2', '2', 'Fila 1', 'Fila racks outdoor', '2015-05-21 20:31:22', '0', '2015-05-21 20:31:22', '0', '1', '1');
INSERT INTO `tbl_row` VALUES ('3', '3', 'Fila 1', 'Fila equipos Cabecera', '2015-05-21 20:39:08', '0', '2015-05-21 20:39:08', '0', '1', '1');
INSERT INTO `tbl_row` VALUES ('4', '3', 'Fila 2', 'Fila equipos HFC', '2015-05-21 20:39:24', '0', '2015-05-21 20:39:24', '0', '1', '1');
INSERT INTO `tbl_row` VALUES ('5', '3', 'Fila 3', 'Fila equipos HFC', '2015-05-21 20:39:35', '0', '2015-05-21 20:39:35', '0', '1', '1');

-- ----------------------------
-- Table structure for tbl_sds
-- ----------------------------
DROP TABLE IF EXISTS `tbl_sds`;
CREATE TABLE `tbl_sds` (
  `sdsId` int(11) NOT NULL AUTO_INCREMENT,
  `departmentId` int(11) NOT NULL,
  `cityId` int(11) NOT NULL,
  `divisionId` int(11) NOT NULL,
  `subdivisionId` int(11) NOT NULL,
  `sdsName` varchar(255) NOT NULL,
  `sdsAddress` varchar(255) NOT NULL,
  `sdsNeighborhood` varchar(255) DEFAULT NULL,
  `sdsDescriptionNotes` varchar(255) DEFAULT NULL,
  `sdsType` int(11) DEFAULT NULL,
  `sdsStatus` int(11) DEFAULT NULL,
  `sdsManager` int(11) DEFAULT NULL,
  `sdsOperator` int(11) DEFAULT NULL,
  `sdsLongitude` varchar(255) DEFAULT NULL,
  `sdsLatitude` varchar(255) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `createUserId` int(11) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `updateUserId` int(11) DEFAULT NULL,
  ...
  `Flag` int(11) DEFAULT '1',
  PRIMARY KEY (`sdsId`),
  KEY `fk_sds_city` (`cityId`),
  KEY `fk_sds_subdivision` (`subdivisionId`),
  KEY `fk_sds_user` (`sdsManager`),
  KEY `fk_sds_department` (`departmentId`),
  KEY `fk_sds_division` (`divisionId`),
  KEY `fk_sds_status` (`sdsStatus`),
  KEY `fk_sds_type` (`sdsType`),
  CONSTRAINT `fk_sds_city` FOREIGN KEY (`cityId`) REFERENCES `tbl_city` (`cityId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_department` FOREIGN KEY (`departmentId`) REFERENCES `tbl_department` (`departmentId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_division` FOREIGN KEY (`divisionId`) REFERENCES `tbl_division` (`divisionId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_status` FOREIGN KEY (`sdsStatus`) REFERENCES `tbl_sds_status` (`sdsStatusId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_subdivision` FOREIGN KEY (`subdivisionId`) REFERENCES `tbl_subdivision` (`subdivisionId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_type` FOREIGN KEY (`sdsType`) REFERENCES `tbl_sds_type` (`sdsTypeId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sds_user` FOREIGN KEY (`sdsManager`) REFERENCES `tbl_user` (`userId`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tbl_sds
-- ----------------------------
INSERT INTO `tbl_sds` VALUES ('112', '15', '15001', '10', '102', 'Tunja Hogares', 'Calle 26 # 11-10', 'Las Nieves', null, '4', '1', '1', null, '', '', '2015-05-20 13:58:15', '1', '2015-05-20 13:58:15', '1', '1', '1');
INSERT INTO `tbl_sds` VALUES ('113', '25', '25307', '10', '102', 'Girardot Residencial', 'Carrera 6A # 21-07', 'San Antonio', null, '4', '1', '1', null, '', '', '2015-05-20 14:00:09', '1', '2015-05-20 14:00:09', '1', '1', '1');
INSERT INTO `tbl_sds` VALUES ('114', '85', '85001', '10', '102', 'Yopal Helechos', 'Carrera 23 # 15-05', 'Los Helechos', null, '2', '1', '1', null, '', '', '2015-05-21 20:30:13', '0', '2015-05-21 20:30:13', '0', '1', '1');

-- ----------------------------
-- Table structure for tbl_sds_operator_assignment
-- ----------------------------
DROP TABLE IF EXISTS `tbl_sds_operator_assignment`;
CREATE TABLE `tbl_sds_operator_assignment` (
  `sdsId` int(11) NOT NULL,
  `userId` int(11) NOT NULL,
  `role` varchar(255) DEFAULT NULL,
  KEY `fk_sdsopassign_sds` (`sdsId`),
  KEY `fk_sdsopassign_user` (`userId`),
  CONSTRAINT `fk_sdsopassign_sds` FOREIGN KEY (`sdsId`) REFERENCES `tbl_sds` (`sdsId`) ON DELETE CASCADE,
  CONSTRAINT `fk_sdsopassign_user` FOREIGN KEY (`userId`) REFERENCES `tbl_user` (`userId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tbl_sds_operator_assignment
-- ----------------------------

-- ----------------------------
-- Table structure for tbl_sds_status
-- ----------------------------
DROP TABLE IF EXISTS `tbl_sds_status`;
CREATE TABLE `tbl_sds_status` (
  `sdsStatusId` int(11) NOT NULL AUTO_INCREMENT,
  `sdsStatusName` varchar(255) DEFAULT NULL,
  `sdsStatusDescription` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sdsStatusId`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tbl_sds_status
-- ----------------------------
INSERT INTO `tbl_sds_status` VALUES ('1', 'Active', 'SDS activo y operativo');
INSERT INTO `tbl_sds_status` VALUES ('2', 'Non active', 'SDS no operativo');

-- ----------------------------
-- Table structure for tbl_sds_type
-- ----------------------------
DROP TABLE IF EXISTS `tbl_sds_type`;
CREATE TABLE `tbl_sds_type` (
  `sdsTypeId` int(11) NOT NULL AUTO_INCREMENT,
  `sdsTypeName` varchar(255) DEFAULT NULL,
  `sdsTypeDescription` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`sdsTypeId`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tbl_sds_type
-- ----------------------------
INSERT INTO `tbl_sds_type` VALUES ('1', 'Unidireccional', 'Soporta redes unidireccionales - Cabeceras');
INSERT INTO `tbl_sds_type` VALUES ('2', 'Bidireccional', 'Soporta redes bidireccionales');
INSERT INTO `tbl_sds_type` VALUES ('3', 'Corporativo', 'Soporta redes corporativas');
INSERT INTO `tbl_sds_type` VALUES ('4', 'Mixto', 'Soporta dos o mas tipos de redes unidireccional, bidireccional y/o corporativos');
...
-- Records of tbl_user
-- ----------------------------
INSERT INTO `tbl_user` VALUES ('0', 'MiguelAngel', 'Carrillo Moreno', 'admin', 'miguel.carrillo@claro.com.co', '$2y$13$lciVikwfx9bYSqa4Is4Ao.cCFT/ozSN3K9E5pF.a7ug8NF6T./Xpu', null, null, '2015-05-21 19:36:17', '2015-04-22 12:50:22', '0', '2015-04-23 15:34:46', '0', '1', '1');
INSERT INTO `tbl_user` VALUES ('1', 'Miguel Angel', 'Carrillo Moreno', 'miguel.carrillo', 'miguel.carrillo@claro.com.co', '$2y$13$b9o.VuawSyfL4G3Fab3gCum28MMAxdcXoF0PaYqDwLfhVPjxJKDPO', null, null, '2015-05-22 14:31:00', '2015-04-22 12:50:22', '1', '2015-04-23 15:35:39', '1', '1', '1');
INSERT INTO `tbl_user` VALUES ('2', 'Javier Alexander', 'Acevedo Parra', 'javier.acevedo', 'javier.acevedo@claro.com.co', '$2y$13$znNdwBr5.TFgG9e0gLZRnOoZMSmfVPCRy7N47LRKGNdY9OBOg9Y82', null, null, '2015-05-14 20:01:18', '2015-04-22 12:50:22', '1', '2015-04-23 15:35:58', '1', '1', '1');
INSERT INTO `tbl_user` VALUES ('3', 'Juan Jose', 'Hernandez Gutierrez', 'juan.hernandez', 'juan.hernandez.g@claro.com.co', '$2y$13$w6NAoBh1qQWdzj0Z.PBCNeUPeCzL5nGdAZzylQLEu4dZ3Wsl5kKSm', null, null, '2015-04-23 15:37:07', '2015-04-22 15:44:48', '1', '2015-04-23 15:36:17', '1', '1', '1');
INSERT INTO `tbl_user` VALUES ('4', 'Luis Alfonso', 'Valdes Cristancho', 'luis.valdes', 'luis.valdes@claro.com.co', '$2y$13$w6NAoBh1qQWdzj0Z.PBCNeUPeCzL5nGdAZzylQLEu4dZ3Wsl5kKSm', null, null, '2015-04-23 15:37:07', '2015-04-22 15:44:48', '1', '2015-04-23 15:36:17', '1', '1', '1');

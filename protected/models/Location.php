...
class Location extends InfraActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'locationName' => Yii::t('rdt', 'Location Name'),
			'locationAddress' => Yii::t('rdt', 'Location Address'),
			'locationNeighborhood' => Yii::t('rdt', 'Location Neighborhood'),
			'locationType' => Yii::t('rdt', 'Location Type'),
			'locationStatus' => Yii::t('rdt', 'Location Status'),
			'locationManager' => Yii::t('rdt', 'Location Manager'),
			'locationOperator' => Yii::t('rdt', 'Location Operator'),
			'locationLongitude' => Yii::t('rdt', 'Location Longitude'),
			'locationLatitude' => Yii::t('rdt', 'Location Latitude'),

...
class LocationStatus extends CActiveRecord
{
	...
	{
		return array(
			'locationStatusId' => Yii::t('rdt', 'Location Status'),
			'locationStatusName' => Yii::t('rdt', 'Location Status Name'),
			'locationStatusDescription' => Yii::t('rdt', 'Location Status Description'),
		);
	}

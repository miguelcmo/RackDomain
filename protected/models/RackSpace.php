...
/**
 * This is the model class for table "{{rack_space}}".
 *
 * The followings are the available columns in table '{{rack_space}}':
 * @property integer $objectId
 * @property integer $rackId
 * @property string $initialRU
 * @property string $endRU
 * @property string $createTime
 * @property integer $createUserId
 * @property string $updateTime
 * @property integer $updateUserId
 */
class RackSpace extends InfraActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('objectId, rackId, initialRU, endRU, createTime, createUserId, updateTime, updateUserId', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'rackId' => Yii::t('rdt', 'Rack'),
			'initialRU' => Yii::t('rdt', 'Initial Ru'),
			'endRU' => Yii::t('rdt', 'End Ru'),
	...
	public function search()
	{
		...
		$criteria->compare('initialRU',$this->initialRU,true);
		$criteria->compare('endRU',$this->endRU,true);
	 ...
	 * @return RackSpace the static model class
	 */

...
<div class="view">
	...
	*/ ?>
	...
	<?php echo CHtml::link(CHtml::encode($data->locationName), array('view', 'id'=>$data->locationId)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('cityId')); ?>:</b>
	<?php echo CHtml::encode($data->city->cityName); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('subdivisionId')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('locationNeighborhood')); ?>:</b>
	<?php echo CHtml::encode($data->locationNeighborhood); ?>
	<br />

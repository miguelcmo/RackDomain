...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'vendorId', $this->getVendorOptions(), array('empty'=>'-- Escoja una opción --')); ?>
		<?php echo $form->error($model,'vendorId'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'chapterId'); ?>
		<?php echo $form->dropDownList($model,'chapterId', $this->getChapterOptions(), array('empty'=>'-- Escoja una opción --')); ?>

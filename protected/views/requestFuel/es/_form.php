...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	*/ ?>
	...
	<div class="row">
		...
		<?php //echo $form->textField($model,'requestLocationId'); 
			$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
				...
				'htmlOptions'=>array(
					'style'=>'height:20px;',
					'placeholder'=>'-- Escoja la Locación --',
				),
			));
		?>
	...
	<div class="row">
		...
		<?php //echo $form->textField($model,'onSiteContactId');
			$this->widget('zii.widgets.jiu.CJuiAutoComplete', array(
				...
				'htmlOptions'=>array(
					'style'=>'height:20px;',
					'placeholder'=>'-- Escoja el Contacto en Sitio --',
				),
			));
		?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'fuelQty',array('placeholder'=>'-- Número de galones requeridos --')); ?>
		<?php echo $form->error($model,'fuelQty'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'fuelTypeId'); ?>
		<?php echo $form->dropDownList($model,'fuelTypeId',$this->getFuelTypeOptions(),array('empty'=>'-- Escoja una opción --')); ?>

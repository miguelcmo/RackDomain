...
$this->menu=array(
	array('label'=>'Regresar a Locación', 'url'=>array('location/view','id'=>$model->location->locationId)),
	array('label'=>'Crear Sala', 'url'=>array('create', 'lid'=>$model->location->locationId)),
);
